...
import uk.gov.hmrc.customs.notification.models.{ClientId, ClientSubscriptionId, HasClientSubscriptionId, HasId, Notification}
...
case class NotificationWorkItem(_id: ClientSubscriptionId,
                                ...
                                notification: Notification) extends HasId with HasClientSubscriptionId {
