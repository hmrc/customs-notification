...
//import uk.gov.hmrc.customs.notification.config.{AppConfig, BasicAuthConfig, CsidTranslationHotfixConfig}
//import uk.gov.hmrc.customs.notification.controllers.Controller
//import uk.gov.hmrc.customs.notification.models.{ClientSubscriptionId, NotificationId}
//import uk.gov.hmrc.customs.notification.services.{CsidTranslationHotfixService, DateTimeService, HeaderCarrierService, IncomingNotificationService, NewNotificationIdService}
...
//import unit.controllers.ControllerSpec._
//import util.TestData
//
//import java.time.ZonedDateTime
//import scala.concurrent.Future
//
//class ControllerSpec extends AsyncWordSpec
//  with Matchers
//  with AsyncMockitoSugar
//  with ResetMocksAfterEachAsyncTest {
//
//  private val mockCsidTranslationHotfixService = new CsidTranslationHotfixService(mock[Logger], mock[CsidTranslationHotfixConfig]){
...
//  }
//  private val mockBasicAuthConfig = mock[BasicAuthConfig]
...
//    when(mockBasicAuthConfig.token).thenReturn(Authorization(TestData.BasicAuthTokenValue))
...
//        when(mockRepo.getFailedAndBlockedCount(eqTo(TestData.ClientId)))
...
//        when(mockRepo.unblockFailedAndBlocked(eqTo(TestData.ClientId)))
