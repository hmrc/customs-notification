...
- Run Unit and Integration Tests with coverage report: `./run_all_tests.sh`<br/> which runs `clean  coverage test IntegrationTest/test coverageReport dependencyUpdates"`
